	...
	public class DigitalFontEffect : PlatformEffect
	{
		...
		protected override void OnAttached()
		{
			try
			{
				...
				Typeface font = Typeface.CreateFromAsset(Forms.Context.Assets,  DroneLander.DigitalFontEffect.GetFontFileName(Element) + ".ttf");
		...
		protected override void OnElementPropertyChanged(PropertyChangedEventArgs args)
		{
			...
			{
				Typeface font = Typeface.CreateFromAsset(Forms.Context.ApplicationContext.Assets,  DroneLander.DigitalFontEffect.GetFontFileName(Element) + ".ttf");
				control.Typeface = font;
			}
		}
	}
